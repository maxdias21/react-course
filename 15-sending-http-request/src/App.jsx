...
function App() {
  ...
  // Não pode usar async no useEffect diretamente e nem dentro da função pai do componente (nesse caso a func App)
  // Mas posso criar uma função dentro do useEffect e ela pode ser async
  useEffect(() => {
